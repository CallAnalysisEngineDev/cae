...
public class AdminControllerImpl implements IAdminController {
	...
	public void adminLoginView(HttpServletRequest request,
	...
	public Map<String, Object> shakeHand(HttpSession session,
		...
		if (type == SecurityAlgorithm.ASK_PUBKEY) {
			...
			theResult.put("summary", md5(publicKey));
	...
	public ModelAndView queryAllSongController(HttpSession session,
